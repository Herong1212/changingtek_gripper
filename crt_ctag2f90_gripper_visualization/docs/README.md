...
copy **crt_ctag2f90_gripper_visualization** to the src folder of your own Ubuntu system ROS workspace and execute the following statement
## Run
...
```sh
cd ./src/crt_ctag2f90_gripper_visualization

roslaunch crt_ctag2f90_gripper_visualization display.launch
...
<center>Figure1 ctag2f90 rviz interface</center>  
...
Run python file:
```sh
cd ~/ws_catkin/src/crt_ctag2f90_gripper_visualization/scripts/

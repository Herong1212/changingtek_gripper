...
copy **crt_ctpm3f20e_gripper_visualization** to the src folder of your own Ubuntu system ROS workspace and execute the following statement.
## Run
...
```sh
cd ./src/crt_ctpm3f20e_gripper_visualization

roslaunch crt_ctpm3f20e_gripper_visualization display_urdf.launch

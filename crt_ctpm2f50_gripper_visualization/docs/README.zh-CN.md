...
复制 **crt_ctpm2f50_gripper_visualization** 文件夹到你自己的ROS的workspace中
## 二、使用说明
...
<center>图1 ctpm2f50 rviz显示图</center>  
...
运行python文件，在终端输入：
```sh
cd ~/ws_catkin/src/crt_ctpm2f50_gripper_visualization/scripts/

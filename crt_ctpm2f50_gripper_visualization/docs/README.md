...
copy **crt_ctpm2f50_gripper_visualization** to the src folder of your own Ubuntu system ROS workspace and execute the following statement
## Run
...
```sh
cd ./src/crt_ctpm2f50_gripper_visualization

roslaunch crt_ctpm2f50_gripper_visualization crt_ctpm2f50_display.launch
...
<center>Figure1 ctpm2f50 rviz interface</center>  
...
Run python file:
```sh
cd ./src/crt_ctpm2f50_gripper_visualization/scripts/

python3 GUI2Robot_listener.py

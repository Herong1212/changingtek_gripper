...
copy **crt_ctag2f120_gripper_visualization** to the src folder of your own Ubuntu system ROS workspace and execute the following statement
...
```sh
cd ./src/crt_ctag2f120_gripper_visualization

roslaunch crt_ctag2f120_gripper_visualization crt_ctag2f120_display.launch
...
<center>Figure1 ctag2f120 rviz interface</center>  
...
Run python file:
```sh
cd ~/ws_catkin/src/crt_ctag2f120_gripper_visualization/scripts/

python3 GUI2Robot_120.py

...
copy **crt_ctpm2f50f_gripper_visualization** to the src folder of your own Ubuntu system ROS workspace and execute the following statement.
## Run
...
```sh
cd ./src/crt_ctpm2f50f_gripper_visualization

roslaunch crt_ctpm2f50f_gripper_visualization display_urdf.launch
...
Run python file:
```sh
cd ./src/crt_ctpm2f50f_gripper_visualization/scripts/

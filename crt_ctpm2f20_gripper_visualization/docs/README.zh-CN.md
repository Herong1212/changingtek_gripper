...
复制 **crt_ctpm2f20_gripper_visualization** 文件夹到你自己的ROS的workspace中
## 二、使用说明
...
roslaunch crt_ctpm2f20_gripper_visualization display.launch  # 同步模式
```

输入完成，会出现rviz界面，如下图：

![image-1](asserts/001.png)
<center>图1 ctpm2f20 rviz显示图</center>  

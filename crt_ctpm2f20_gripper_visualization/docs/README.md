...
copy **crt_ctpm2f20_gripper_visualization** to the src folder of your own Ubuntu system ROS workspace and execute the following statement
## Run
...
```sh
cd ./src/crt_ctpm2f20_gripper_visualization

roslaunch crt_ctpm2f20_gripper_visualization display.launch   # Synchronous mode
```

After inputting,Rviz interface will come out:

![image-1](asserts/001.png#pic_center)
<center>Figure1 ctpm2f20 rviz interface</center>  
